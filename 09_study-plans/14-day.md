...
### Day 1 — Diagnostic + L01–L02 (3.5h)

**Morning (1h): Diagnostic**
- Complete `diagnostic-checklist.md`
...
- Record scores in `06_progress/student-progress.md`

**Pass criterion:** ≥60% on both drill sets.
...
**Pass criterion:** ≥65% across L01–L03 drills.

---

## Phase 2 — Tier-1★ Topics (Days 3–6)
...
## Phase 3 — Remaining Topics (Days 7–10)
...
**Pass criterion:** ≥60% self-quiz on struct syntax.
...
**Pass criterion:** ≥60% on recursion trace problems.

---

## Phase 4 — Review + Exams (Days 11–14)

### Day 11 — Spaced Review: Weakest Topics (3h)

- Pull your lowest 3 scores from `06_progress/student-progress.md`
- For each weak topic: open `10_remediation/` if available, otherwise re-do drills Q1–4
- Focus order: Pointers → Arrays → Functions → Loops → others
- Record updated scores

**Pass criterion:** All Tier-1 scores ≥70% before Day 12.
...
**Post-exam (1h):**
- For each wrong answer: tag the topic
- Open the corresponding remediation file if score on that topic < 70%

**Pass criterion:** Mock A ≥65%. If below, add a remediation session before Day 14.

---

### Day 13 — Gap Analysis + Remediation (3h)

- Review Mock A wrong answers in detail
- For each failed topic open `10_remediation/` and work through the plan
- Redo 5 drill questions per weak topic
- Update mastery bands in `07_mastery/mastery-rubric.md`

**Focus priority:**
1. `10_remediation/pointers.md` if L07 < 70%
2. `10_remediation/arrays.md` if L05 < 70%
3. `10_remediation/functions.md` if L06 < 70%
4. `10_remediation/loops.md` if L04 < 70%
...
**Readiness check (30min):**
- Open `acceptance-test.md`
- Work through the checklist
- If all Tier-1 topics ≥75% and Mock B ≥70%: → **Plan complete, advance to 30-day or exam**
- If below: extend with 7-day remediation sprint or begin 30-day plan from Day 15

---

## Score Log

| Day | Topic/Event | Score | Pass? |
|-----|------------|-------|-------|
| 1 | L01 + L02 drills | /10 | |
| 2 | L03 + L01/L02 review | /10 | |
| 3 | L04 Loops | /10 | |
| 4 | L05 Arrays | /10 | |
| 5 | L06 Functions | /10 | |
| 6 | L07 Pointers | /10 | |
