...
幾何的意味: $$\mathbf{a} \cdot \mathbf{b} = \vert \mathbf{a}\vert \vert \mathbf{b}\vert \cos\theta$$ （$$\theta$$ は2ベクトルのなす角）
...
幾何的意味: $$\vert \mathbf{a}\times\mathbf{b}\vert  = \vert \mathbf{a}\vert \vert \mathbf{b}\vert \sin\theta$$ = $$\mathbf{a}$$, $$\mathbf{b}$$ が作る平行四辺形の面積
...
$$V = \vert \mathbf{a}\cdot(\mathbf{b}\times\mathbf{c})\vert $$
...
**解**:
$$V=\left\vert \begin{vmatrix}1&2&-1\\2&-1&3\\1&1&1\end{vmatrix}\right\vert $$
