...
$$\iint_D (x^2 - y^2)\,dx\,dy, \quad D = \{(x,y) \mid |x|+|y| \le 1\}$$
...
**領域の確認**: $D=\{|x|+|y|\le1\}$ はひし形（頂点: $(1,0),(0,1),(-1,0),(0,-1)$）
...
固有値:
$$\lambda_1 = 1, \quad \lambda_{2,3} = 1 \pm \sqrt{2}\,|a|$$
...
**R6 追加の示唆**:
- ひし形領域 $|x|+|y|\le1$ の重積分 → 対称性を使う技術が必要
