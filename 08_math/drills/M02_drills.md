...
- **Easy が不安** → M02 教科書の「行列式・逆行列」節を再読
- **Medium まで解けた** → M03 固有値・対角化へ進む
- **Hard まで完走** → 過去問 R8-2 の大問I（行列問題）に挑戦

> **M03 固有値・対角化** は Tier 1 ★ トピック。M02 の対角化（M2, M5, H1, H3〜H5）が素早く解けるようになってから進むと効率がよい。
